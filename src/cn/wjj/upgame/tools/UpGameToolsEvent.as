package cn.wjj.upgame.tools
{
	 ...
	 * @author GaGa
	 */
	public class UpGameToolsEvent extends Event implements IEventDispatcher
	{
		...
		private static var instance:UpGameToolsEvent;
		
		private static var dispatcher:EventDispatcher;
		
		public function UpGameToolsEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false):void
		{
			super(type, bubbles, cancelable);
		}
		
		public static function get getInstance():UpGameToolsEvent
		{
			if (instance)
			{
				return instance;
			...
			{
				instance = new UpGameToolsEvent(UpGameToolsEvent.instanceUse);
		...
		{
			var e:UpGameToolsEvent = new UpGameToolsEvent(type, bubbles, cancelable);
			return e;
		}
	}
}
