package cn.wjj.upgame.engine
{
	 ...
	 * @author GaGa
	 */
	public class AIBulletTrackPenetrateHit extends AIBulletTrack
	{
		/** 对象池 **/
		...
		public function AIBulletTrackPenetrateHit() { }
		/** 初始化 **/
		public static function instance():AIBulletTrackPenetrateHit
		{
			var o:AIBulletTrackPenetrateHit = __f.instance() as AIBulletTrackPenetrateHit;
			if (o) return o;
			return new AIBulletTrackPenetrateHit();
		}
