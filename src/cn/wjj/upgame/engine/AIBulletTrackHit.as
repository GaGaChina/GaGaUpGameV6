package cn.wjj.upgame.engine 
{
	 ...
	 * @author GaGa
	 */
	public class AIBulletTrackHit extends AIBulletTrack
	{
		/** 对象池 **/
		...
		public function AIBulletTrackHit() { }
		/** 初始化 **/
		public static function instance():AIBulletTrackHit
		{
			var o:AIBulletTrackHit = __f.instance() as AIBulletTrackHit;
			if (o) return o;
			return new AIBulletTrackHit();
		}
